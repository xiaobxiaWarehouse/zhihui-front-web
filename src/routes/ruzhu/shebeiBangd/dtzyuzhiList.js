...
const Dtzmorenyuzhi = (props) => {
  ...
  return (
    <div className="content-inner-gray">
      ...
      {/* <Row>
        <Col span={24}>
          <FormItem {...formItemLayout} label="缺省阈值">
            {getFieldDecorator('moren', {
              initialValue: 2,
              rules: [
                {required: true, message: '请选择缺省阈值'},
              ],
            })(<RadioGroup onChange={(val) => { onChangeYuzhi(val); }}>
              <Radio value={1}>是</Radio>
              <Radio value={2} style={{marginLeft: 40}}>否</Radio>
            </RadioGroup>)}
          </FormItem>
        </Col>
      </Row> */}
                ...
                <Col span={4}>
                  <FormItem>
                    {getFieldDecorator('hrmin', {
                      // initialValue: yuzhiDuotizheng ? yuzhiDuotizheng.hr.min : undefined,
                      rules: [],
                ...
                <Col span={4}>
                  <FormItem>
                    {getFieldDecorator('hrmax', {
                      // initialValue: yuzhiDuotizheng ? yuzhiDuotizheng.hr.max : undefined,
                      rules: [],
                    })(<InputNumber min={1} style={{width: '100%'}}/>)}
                  </FormItem>
                </Col>
                ...
                <Col span={4}>
                  <FormItem>
                    {getFieldDecorator('sbpmin', {
                      // initialValue: yuzhiDuotizheng ? yuzhiDuotizheng.sbp.min : undefined,
                      rules: [],
                    })(<InputNumber min={1} style={{width: '100%'}}/>)}
                  </FormItem>
                </Col>
                ...
                <Col span={4}>
                  <FormItem>
                    {getFieldDecorator('sbpmax', {
                      // initialValue: yuzhiDuotizheng ? yuzhiDuotizheng.sbp.max : undefined,
                      rules: [],
                    })(<InputNumber min={1} style={{width: '100%'}}/>)}
                  </FormItem>
                </Col>
                ...
                <Col span={4}>
                  <FormItem>
                    {getFieldDecorator('dbpmin', {
                      // initialValue: yuzhiDuotizheng ? yuzhiDuotizheng.dbp.min : undefined,
                      rules: [],
                    })(<InputNumber min={1} style={{width: '100%'}}/>)}
                  </FormItem>
                </Col>
                ...
                <Col span={4}>
                  <FormItem>
                    {getFieldDecorator('dbpmax', {
                      // initialValue: yuzhiDuotizheng ? yuzhiDuotizheng.dbp.max : undefined,
                      rules: [],
                    })(<InputNumber min={1} style={{width: '100%'}}/>)}
                  </FormItem>
                </Col>
                ...
                <Col span={4}>
                  <FormItem>
                    {getFieldDecorator('tempmin', {
                      // initialValue: yuzhiDuotizheng ? yuzhiDuotizheng.temp.min : undefined,
                      rules: [],
                    })(<InputNumber min={1} style={{width: '100%'}}/>)}
                  </FormItem>
                </Col>
                ...
                <Col span={4}>
                  <FormItem>
                    {getFieldDecorator('tempmax', {
                      // initialValue: yuzhiDuotizheng ? yuzhiDuotizheng.temp.max : undefined,
                      rules: [],
                    })(<InputNumber min={1} style={{width: '100%'}}/>)}
                  </FormItem>
                </Col>
                ...
                <Col span={4}>
                  <FormItem>
                    {getFieldDecorator('bgmin', {
                      // initialValue: yuzhiDuotizheng ? yuzhiDuotizheng.bg.min : undefined,
                      rules: [],
                    })(<InputNumber min={1} style={{width: '100%'}}/>)}
                  </FormItem>
                </Col>
                ...
                <Col span={4}>
                  <FormItem>
                    {getFieldDecorator('bgmax', {
                      // initialValue: yuzhiDuotizheng ? yuzhiDuotizheng.bg.max : undefined,
                      rules: [],
                    })(<InputNumber min={1} style={{width: '100%'}}/>)}
                  </FormItem>
                </Col>
                ...
                <Col span={4}>
                  <FormItem>
                    {getFieldDecorator('spo2min', {
                      // initialValue: yuzhiDuotizheng ? yuzhiDuotizheng.spo2.min : undefined,
                      rules: [],
                    })(<InputNumber min={1} style={{width: '100%'}}/>)}
                  </FormItem>
                </Col>
                ...
                <Col span={4}>
                  <FormItem>
                    {getFieldDecorator('spo2max', {
                      // initialValue: yuzhiDuotizheng ? yuzhiDuotizheng.spo2.max : undefined,
                      rules: [],
                    })(<InputNumber min={1} style={{width: '100%'}}/>)}
                  </FormItem>
                </Col>
