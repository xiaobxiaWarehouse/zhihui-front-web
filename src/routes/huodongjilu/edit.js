...
class Add extends React.Component {
  ...
  componentWillReceiveProps(newProps) {
    const {huodongjilu} = this.props;
    const {editData} = huodongjilu;
    if (!(editData && editData.shijian) && newProps.huodongjilu && newProps.huodongjilu.editData && newProps.huodongjilu.editData.shijian) {
      this.setState({
        date: moment(newProps.huodongjilu.editData.shijian, 'YYYY-MM-DD HH:mm').toDate(),
      });
    }
  }
  ...
  render() {
    ...
    const save = () => {
      validateFields((errors) => {
        ...
        dispatch({
          type: 'huodongjilu/modifyHuodongjilu',
          payload: {
    ...
    let initHuodongjiluRq;
    if (editData && editData.shijian) {
      const { shijian } = editData;
      initHuodongjiluRq = moment(shijian, 'YYYY-MM-DD HH:mm').toDate();
    }
        ...
        <div className="add-wrap">
          <div className="header">
            <div className="navGroup">
              <Row className="nav">
                <Col className="title">修改活动记录</Col>
                    ...
                    <Col span={5}>
                      <FormItem>
                        {getFieldDecorator('huodongjiluRq', {
                          initialValue: editData && editData.shijian && initHuodongjiluRq,
                          rules: [
                ...
                <Col span={24}>
                  <FormItem {...formItemLayout} label="关联计划">
                    {getFieldDecorator('huodongJh', {
                      initialValue: editData && editData.huodongJh ? editData.huodongJh : undefined,
                      rules: [
                      ],
                ...
                <Col span={24}>
                  <FormItem {...formItemLayout} label="活动主题">
                    {getFieldDecorator('zhuti', {
                      initialValue: editData && editData.zhuti ? editData.zhuti : undefined,
                      rules: [
                ...
                <Col span={24}>
                  <FormItem {...formItemLayout} label="参加单位">
                    {getFieldDecorator('canjiaDw', {
                      initialValue: editData && editData.canjiaDw ? editData.canjiaDw : undefined,
                      rules: [
                      ],
                ...
                <Col span={24}>
                  <FormItem {...formItemLayout} label="活动地点">
                    {getFieldDecorator('didian', {
                      initialValue: editData && editData.didian ? editData.didian : undefined,
                      rules: [
                      ],
                ...
                <Col span={12}>
                  <FormItem {...formItemLayout2} label="电话">
                    {getFieldDecorator('zerenrenDh', {
                      initialValue: editData && editData.zerenrenDh ? editData.zerenrenDh : undefined,
                      rules: [
                      ],
