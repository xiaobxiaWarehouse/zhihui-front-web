...
const Filter = (props) => {
  ...
  return (
    <Form layout="inline">
      <Row className={styles.danganFilter}>
        <Col span={8}>
          <FormItem label="楼号">
        ...
        <Col span={8}>
          <FormItem label="房号">
            {getFieldDecorator('fanghao', {
              initialValue: filter && filter.fanghao !== null && filter.fanghao !== undefined ? filter.fanghao : '',
              rules: [],
